...
/* Trigger por el que al insertar un usuario al sistema, antes de llevarse a la
tabla, indique la fecha-hora de conexión a la del momento de crearse */
CREATE TRIGGER fechaHoraPrimeraConexion BEFORE INSERT ON T01_Usuario
FOR EACH ROW SET NEW.T01_FechaHoraUltimaConexion = NOW();